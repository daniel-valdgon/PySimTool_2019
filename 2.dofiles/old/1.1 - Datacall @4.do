...
if (`_addtop'==1) append using "$data_pry/topincs@4.dta", gen(mysource)
...
horab horabc horabco tipohoga njef ncon npad nmad tic01 tic02 tic03 ///
...
v21gde ingrem autocneto_hh autocneto_j y ed08 ed09
