...
* Este do-file estima los efectos indirectos de reduccion en las tasas ISC 2019 en cigarrillos
*===================================================================================================================
clear
set more off
...
costpush `sectors', fixed(fixed_isc) priceshock(dp_isc) genptot(total_isc19CIG_10) genpind(indirect_isc19CIG_10) 

list total_isc19CIG_10 indirect_isc19CIG_10
...
merge 1:1 _n using `isc_effects', nogen keepusing(total_isc19CIG_10 indirect_isc19CIG_10)
gen dp = 0
foreach sec in `fixprice' {
replace dp= total_isc19CIG_10 in `sec'  
}
drop   total_isc19CIG_10 indirect_isc19CIG_10


/*

gen dp = 0
replace dp = -0.000000001173 in 1
replace dp = -0.000000000351 in 2
replace dp =  0.000000000000 in 3
replace dp = -0.000000002038 in 4
replace dp = -0.000000000890 in 5
replace dp = -0.000000000767 in 6
replace dp = -0.000000000380 in 7
replace dp = -0.000000000696 in 8
replace dp = -0.000000000602 in 9
replace dp = -0.000000000978 in 11
replace dp = -0.000000001458 in 12
replace dp = -0.000000000838 in 13
replace dp = -0.000000000784 in 14
replace dp = -0.000000001783 in 15
replace dp = 0.000000000000 in 16
replace dp = -0.000000000762 in 17
replace dp = -0.000000000761 in 18
replace dp = -0.000000000743 in 19
replace dp = -0.000000000762 in 20
replace dp = -0.000000000902 in 21
replace dp = -0.000000000375 in 22
replace dp = -0.000000000375 in 23
replace dp = -0.000000000387 in 24
replace dp = -0.000000001194 in 25
replace dp = 0.000000000000 in 26
replace dp = -0.000000001131 in 27
replace dp = -0.000000001132 in 28
replace dp = -0.000000001131 in 29
replace dp = -0.000000001135 in 30
replace dp = 0.000000000000  in 31
replace dp = -0.000000001141 in 32
replace dp = -0.000000029570 in 33
replace dp = -0.000000000064 in 34
replace dp = -0.000000000464 in 35
replace dp = -0.000000002147 in 36
replace dp = -0.000000000284 in 37
replace dp = -0.000000000347 in 38
replace dp = -0.000000000863 in 39
replace dp = -0.000000000372 in 40
replace dp = -0.000000000018 in 41
replace dp = -0.000000000307 in 42
replace dp = 0.000000000000 in 43
replace dp = 0.000000000000 in 44
replace dp = 0.000000000000 in 45
replace dp = -0.000000000365 in 47
replace dp = -0.000000000031 in 48
*/

costpush `sectors', fixed(fixed) priceshock(dp) genptot(total_isc19CIG_11) genpind(indirect_isc19CIG_11)

list total_isc19CIG_11 indirect_isc19CIG_11
...
keep  sectorio sectorioe total_isc19CIG_10 indirect_isc19CIG_10 total_isc19CIG_11 indirect_isc19CIG_11

order sectorio sectorioe total_isc19CIG_10 indirect_isc19CIG_10 total_isc19CIG_11 indirect_isc19CIG_11

tempfile efectos_isc_cigarrillos_2019
save `efectos_isc_cigarrillos_2019'

*save "$data_pry\efectos_isc_cigarrillos_2019.dta", replace
